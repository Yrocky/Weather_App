...
@implementation MMHomeModule (CollectionView)

//- (id<MMHomeSectionComponentAble>) componentAtSection:(NSInteger)section{
//    return [self compontnetAtIndex:section];
//}
//
...
//    return [[self componentAtSection:section] numberOfItems];
//}
//- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
//    return [[self componentAtSection:indexPath.section]
