...
@interface MMGCDTimerManager()
@property (nonatomic, strong) NSMutableDictionary *timerContainer;
@property (nonatomic, strong) NSMutableDictionary *actionBlockCache;
@end

@implementation MMGCDTimerManager

#pragma mark - Public Method

+ (MMGCDTimerManager *)sharedInstance
{
    static MMGCDTimerManager *_gcdTimerManager = nil;
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken,^{
        _gcdTimerManager = [[MMGCDTimerManager alloc] init];
    });
